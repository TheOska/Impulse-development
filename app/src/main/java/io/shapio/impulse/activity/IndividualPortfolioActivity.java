 ...
 */
public class IndividualPortfolioActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private String TAG = IndividualPortfolioActivity.class.getSimpleName();
